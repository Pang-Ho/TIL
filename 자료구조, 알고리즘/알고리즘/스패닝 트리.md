      ...
      if(this.parent.get(currentEdge.nodeV) != this.parent.get(currentEdge.nodeU)) {
        ...
        if(this.parent.get(currentEdge.nodeV) == currentEdge.nodeV) {
          ...
          if(this.parent.get(currentEdge.nodeU) == currentEdge.nodeU) {
            this.parent.put(currentEdge.nodeV, currentEdge.nodeU);
            this.rank.put(currentEdge.nodeU, this.rank.get(currentEdge.nodeU) + 1);

          //1-1-2. U부모는 자기 자신이 아닌경우
          } else {
            this.parent.put(currentEdge.nodeV, this.parent.get(currentEdge.nodeU));
          }
        ...
        //1-2. V부모가 자기 자신이 아닌 경우
          ...
          //1-2-2. 둘 다 부모가 자기 자신이 아닌 경우
          } else {
            if(this.rank.get(currentEdge.nodeV) > this.rank.get(currentEdge.nodeU) {
              this.parent.put(currentEdge.nodeU, currentEdge.nodeV);
            } else {
              this.parent.put(currentEdge.nodeV, currentEdge.nodeU);
